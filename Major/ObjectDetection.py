...
while True:
    ...
    for (x,y,w,h) in Red_cups:
        ...
        text = "Cups"
        cv2.putText(resize_frame, text, (x, h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (cars_x, cars_y, cars_w, cars_h) in cars:
        ...
        text = "Car"
        cv2.putText(resize_frame, text, (cars_x, cars_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (WallClock_x, WallClock_y, WallClock_w, WallClock_h) in WallClock:
        ...
        text = "Clock"
        cv2.putText(resize_frame, text, (WallClock_x, WallClock_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (nose_x, nose_y, nose_w, nose_h) in nose:
        ...
        cv2.putText(resize_frame, text, (nose_x, nose_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (banana_x, banana_y, banana_w, banana_h) in banana:
        ...
        text = "banana"
        cv2.putText(resize_frame, text, (banana_x, banana_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (Football_cascade_x, Football_cascade_y, Football_cascade_w, Football_cascade_h) in Football_cascade:
        ...
        text = "football"
        cv2.putText(resize_frame, text, (Football_cascade_x, Football_cascade_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (eye_x,eye_y, eye_w, eye_h) in eye:
        ...
        text = "eye"
        cv2.putText(resize_frame, text, (eye_x, eye_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (stop_signal_x, stop_signal_y, stop_signal_w, stop_signal_h) in stop_signal:
        ...
        text = "stop-sign"
        cv2.putText(resize_frame, text, (stop_signal_x, stop_signal_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (plate_x, plate_y, plate_w, plate_h) in plate:
        ...
        text = "No.Plate"
        cv2.putText(resize_frame, text, (plate_x, plate_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
    ...
    for (trafic_light_x, trafic_light_y, trafic_light_w, trafic_light_h) in trafic_light:
        ...
        text = "Trafic light"
        cv2.putText(resize_frame, text, (trafic_light_x, trafic_light_h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,0), lineType=cv2.LINE_AA)
